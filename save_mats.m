...
D = spm_eeg_load(fullfile(Pdir,t,extname,printf('%s_%s_%s_ica.mat',prefix,t,subjid)));
...
for i = 1:length(condNames)
    ...
    cond = find(condNames{i}(5:6),conds); % find index for either arabic or dari stimuli
